...
module K2Connect
  # TO DO -David Nino- Check up on validation and Hash Output
  ...
  #     raise K2RepeatTokenRequest.new unless access_token.nil? && @access_token.nil?
  #   else
  #     raise K2NilAccessToken.new if access_token.nil? && @access_token.nil?
  #   end
