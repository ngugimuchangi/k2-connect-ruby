...
RSpec.describe K2Pay do
  before(:all) do
    ...
    @query_pay_recipient_response = { 'data': { id: "f8889531-c96f-4d2d-9f4e-ddb86f3a7acd", type: "pay_recipient", attributes: { recipient_type: "BankAccount", first_name: 'David', last_name: 'Mwangi', phone: "+254999999999", email: "johndoe@nomail.net", network: 'Safaricom', account_name: "John Bank", account_number: "123456789", bank_id: "c7f300c0-f1ef-4151-9bbe-005005aa3747", bank_branch_id: "c7f300c0-f1ef-4151-9bbe-005005aa3747" } } }
  end

  context '#pay_recipients' do
    let(:k2pay) { K2Pay.new(K2AccessToken.new('BwuGu77i5M0SdCc9-R8haR3v0rIR5XsG4xYte27zxjs', '42aPhB6gF7u5n-r0-aL7fQkOVHAzoIYNPr4Nw-wCxQE').request_token) }
    ...
    it 'should add pay recipient request' do
      #test_response = SpecStubRequest.stub_request('post', K2Config.path_variable('pay_recipient'), @pay_request_body, 201,
      ...
      expect(k2pay.location_url).not_to eq(nil)
  ...
  #    test_response = SpecStubRequest.stub_request('post', K2Config.path_variable('payments'), @create_request_body, 201,
  ...
  #    test_response = SpecStubRequest.stub_request('get', 'api/v1/pay_recipients/9b4333bb-1f37-453a-b555-5924b5118a5b', '', 200, nil, @query_pay_recipient_response)
  #    expect(test_response.body).not_to eq(nil)
  #    expect(WebMock).to have_requested(:get, URI.parse('http://127.0.0.1:3000/api/v1/pay_recipients/9b4333bb-1f37-453a-b555-5924b5118a5b'))
  #  end
  #
  #  it 'should query creating payment request status' do
  #    test_response = SpecStubRequest.stub_request('get', 'api/v1/payments/', @create_request_body, 200, nil, @query_create_pay_response)
  #    expect(test_response.body).not_to eq(nil)
  #    expect(WebMock).to have_requested(:get, URI.parse('http://127.0.0.1:3000/api/v1/payments/'))
  #  end
  #end
end
