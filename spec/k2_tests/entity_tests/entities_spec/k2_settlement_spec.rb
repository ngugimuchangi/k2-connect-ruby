...
RSpec.describe K2Settlement do
  ...
  context 'Creating a Settlement Account' do
    it 'should creating verified mobile wallet settlement account' do
      SpecStubRequest.stub_request('post', K2Config.path_url('settlement_mobile_wallet'), @mobile_settle_account, 200)
    ...
    it 'should query creating verified settlement account status' do
      SpecStubRequest.stub_request('get', @k2settlement.location_url, '', 200)
    ...
    it 'should creating verified bank settlement account' do
      SpecStubRequest.stub_request('post', K2Config.path_url('settlement_bank_account'), @bank_settle_account, 200)
