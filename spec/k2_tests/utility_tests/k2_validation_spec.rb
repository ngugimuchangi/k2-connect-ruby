...
RSpec.describe K2ConnectRuby::K2Utilities::K2Validation do
  ...
  describe '#validate_hash' do
    ...
    it 'should raise an error if the_input parameters are incorrect' do
      expect { validate_hash(incorrect_input, array) }.to raise_error K2ConnectRuby::K2IncorrectParams
    end

    it 'should raise an error if the_input has empty values' do
      expect { validate_hash(invalid_input, array) }.to raise_error K2ConnectRuby::K2EmptyParams
    end
