RSpec.describe K2ConnectRuby::K2Utilities::K2Connection do
  ...
  describe '#to_connect' do
    ...
    it 'should raise an error if access_token is empty' do
      expect { K2ConnectRuby::K2Utilities::K2Connection.make_request(nil_token_hash) }.to raise_error ArgumentError
    end

    it 'should raise an error if request_type is neither a post nor get' do
      expect { K2ConnectRuby::K2Utilities::K2Connection.make_request(invalid_hash) }.to raise_error NameError
    end
